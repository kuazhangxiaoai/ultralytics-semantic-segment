...
from ultralytics.utils import DEFAULT_CFG, RANK, YUSEG_CFG
from ultralytics.utils.plotting import plot_masks, plot_results
from ultralytics.utils.torch_utils import unwrap_model


class YUSegTrainer(yolo.detect.DetectionTrainer):
    ...
    def __init__(self, cfg=YUSEG_CFG, overrides=None, _callbacks=None):
        """Initialize a SegmentationTrainer object with given arguments."""
        if overrides is None:
            overrides = {}
        overrides["task"] = "yuseg"
...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = cfg.model or "yolo11-yuseg.yaml"
    ...
    if use_python:
        ...
        trainer = YUSegTrainer(cfg=cfg, overrides=args)
        trainer.train()
